class School < ActiveRecord::Base
  ...
  validates_numericality_of :min_grade, only_integer: true, less_than_or_equal_to: 12, greater_than_or_equal_to: 0
  # the max_grade must be greater than or equal to min_grade
  validates_numericality_of :max_grade, only_integer: true, less_than_or_equal_to: 12, greater_than_or_equal_to: :min_grade
